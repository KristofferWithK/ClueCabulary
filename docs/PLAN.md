...
### Ready
- **O3** — The suitcase tour and the arrival *(O2 done — the tutorial ends to Home where the tour slots in; note the O2 DECISIONS entry: the cargo the tour points at is DISCOVERED words, none collected — structural)*
