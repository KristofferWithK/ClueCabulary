...
describe('planGuessExecution', () => {
   ...
   * anyway. A player asked why Casey answered «hvid» to the clue «foster», and
...
describe('OllamaCompanion.getClue', () => {
   ...
   * strongest association belongs to a word that is not Casey's, so his second
 ...
 * something obvious like water or fish and it was wrong." (Reported before the
 ...
 *
 * This is not a corner case. The deal makes Casey's greens the words the player
