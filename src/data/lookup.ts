 ...
 * "what is the Danish for X?" — and the reverse, when Klaus clues in Danish and
 * the word is new.
 *
 ...
 * a train. Anything outside it goes to Klaus, but only when asked.
 */
 ...
 * word is outside the thousand — which is when Klaus is worth asking.
 */
